...
python3 get_property_similar_concepts.py --config_file configs/2_configs_get_embeds_and_train_data/ufet/ufet_contrastive_bb_get_property_similar_50concepts.json
