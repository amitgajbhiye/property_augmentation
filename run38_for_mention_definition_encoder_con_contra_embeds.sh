...
# Mention Embeds
python3 get_embeds_and_train_data.py --config_file configs/2_configs_get_embeds_and_train_data/ufet/ce_cnetp_chatgpt_vocab/9_for_mention_encoder_get_con_vocab_embed_conceptcontra_bert_large_cnetp_chatgpt100k_pt_model copy.json
